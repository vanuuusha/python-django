...
class Profile(models.Model):
    ...
    # TODO а как тут в поле avatar сделать так, чтоб не вылетала ошибка NOT NULL constraint failed
    ...
    # TODO для теста тут решил создать такое же поле avatar2 и оно сразу заработало, могло быть дело в том,
